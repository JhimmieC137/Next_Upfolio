        ...
        <main className="w-full relative">
            <div className='max-w-screen m-auto overflow-hidden'>
                <div className='px-2 lg:px-8 min-h-full'>
                    ...
                    <section id="hero" className="relative h-[65vh] flex flex-col justify-center items-center mx-auto max-w-2xl md:max-w-3xl lg:max-w-6xl pt-16 pb-20 md:pt-24 md:pb-20 lg:pb-5">
                    ...
                    <section className="relative mx-auto max-w-2xl md:max-w-[52rem] mt-5 md:mt-20 xl:mt-0 lg:max-w-[1300px] flex justify-between gap-10">
                        <div className="w-[83%]">
                            <img className="w-full rounded-[1rem]" src="/jpg/contact_us.jpg" alt="contact_us"/>
                        </div>
                        <form className="w-full px-2" action="">
                            <div className="w-full flex flex-col justify-between">
                                <div className="w-full">
                                    <div className="w-full mb-5 flex flex-col">
                                        <label className="mb-3 pl-1 text-lg text-zinc-400" htmlFor="name">
                                            Name
                                        </label>
                                        <div className="relative w-full">
                                            <RxPerson className='absolute text-zinc-400/60 h-10 w-10 top-5 bottom-auto left-4 z-10' />
                                            <input id="name" type="text" placeholder="John" className="relative placeholder:text-zinc-400/60 text-white/90 w-full pl-[4.2rem] pr-4 text-[1.2rem] border border-zinc-600 rounded-[0.85rem] h-20" required/>
                                        </div>
                                    </div>
                                    <div className="w-full my-5 flex flex-col">
                                        <label className="mb-3 pl-1 text-lg text-zinc-400" htmlFor="phone">
                                            Phone
                                        </label>
                                        <div className="relative w-full">
                                    ...
                                    <div className="w-full my-5 flex flex-col">
                                        <label className="mb-3 pl-1 text-lg text-zinc-400" htmlFor="email">
                                            Email
                                        </label>
                                        <div className="relative w-full">
                                            <CiMail className='absolute  text-zinc-400/60 h-10 w-10 top-5 bottom-auto left-4 z-10' />
                                            <input id="email" type="text" placeholder="example@mail.com" className="relative placeholder:text-zinc-400/60 text-white/90 w-full pl-[4.2rem] pr-4 text-[1.2rem] border border-zinc-600 rounded-[0.85rem] h-20" required/>
                                        </div>
                                    </div>
                                    <div className="w-full my-5 flex flex-col">
                                        <label className="mb-3 pl-1 text-lg text-zinc-400" htmlFor="message">
                                            Your message
                                        </label>
                    ...
                    <section className="relative mx-auto max-w-2xl md:max-w-[52rem] mt-5 md:mt-20 xl:mt-20 lg:max-w-[1300px] flex flex-col justify-between ">
                        <div className="w-full py-5 flex justify-between gap-10">
                            <div className="w-2/6 flex justify-center items-center gap-3">
                        ...
                        <div className="w-full rounded-[2rem]">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11855.8621423493!2d3.907607665226474!3d7.418770170261981!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1039ed5bb43aa999%3A0x77a78d14caa75a20!2sBodija%20Zone%2C%20Ibadan%20200132%2C%20Oyo!5e0!3m2!1sen!2sng!4v1729108743466!5m2!1sen!2sng" 
                                // width="600" 
                                // height="450" 
                                style={{ border: 0, width: '100%', height: '500px', borderRadius: "25px"}} 
