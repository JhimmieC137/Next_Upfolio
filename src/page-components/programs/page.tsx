                                                ...
                                                <div className="flex flex-col item-center max-w-[36rem]">
                                                    <div className='relative w-full max-w-[43rem] max-h-[36rem] xl:rounded-[2rem] rounded-[1rem] mb-3 overflow-hidden'>
                                                        ...
                                                        <Link href={`/programs/${el.path}`}>
                                                            <img className='cursor-pointer relative w-full' src={`/upfolio_programs/Information-Sessions/${el.image}`} alt=''/>
                                                        </Link>
                                                    </div>
                                                    <div className="flex flex-col jw-full">
                                                        <Link href={`/programs/${el.path}`} className='text-xl md:text-2xl lg:text-3xl text-zinc-300 max-w-max my-3 lg:my-7  cursor-pointer hover:text-pink-500 ease-in-out duration-200'>
                                                            {el.title}
                                                        </Link>
                                            ...
                                            <div className="flex flex-col items-center w-full mb-10">
                                                <div className="flex flex-col item-center max-w-[36rem]">
                                                    <div className='relative w-full max-w-[43rem] max-h-[36rem] xl:rounded-[2rem] rounded-[1rem] mb-3 overflow-hidden'>
                                                        ...
                                                        <Link href={`/programs/${el.path}`}>
                                                            <img className='cursor-pointer relative w-full' src={`/upfolio_programs/Capacity-Development/${el.image}`} alt=''/>
                                                        </Link>
                                                    </div>
                                                    <div className="flex flex-col jw-full">
                                                        <Link href={`/programs/${el.path}`} className='text-xl md:text-2xl lg:text-3xl text-zinc-300 max-w-max my-3 lg:my-7 cursor-pointer hover:text-pink-600 ease-in-out duration-200'>
                                                            {el.title}
                                                        </Link>
                                                        <p className="text-sm font-normal text-zinc-400 mb-5">
                                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda voluptatem optio perferendis et consectetur.
